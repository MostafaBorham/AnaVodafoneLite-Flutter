...
class AuthSuccessView extends StatelessWidget {
  AuthSuccessView({Key? key}) : super(key: key);
  late Size _viewSize;
  @override
  ...
  Widget _buildBody(context) => Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text('Success!',style: Theme.of(context).textTheme.titleLarge?.copyWith(
          color: Colors.black,
        ...
        Text('Your request has been done successfully',textAlign : TextAlign.center,style: Theme.of(context).textTheme.titleSmall?.copyWith(
            color: Colors.black,
            fontWeight: FontWeight.w400
        ),),
        const SizedBox(
